...
def parse_args(argv=None):
    ...
    parser.add_argument('--backends', nargs='+', choices=['primal_dual', 'ortools', 'gurobi_network'], default=['ortools'])
    parser.add_argument('--target-oracle-backend', choices=['primal_dual', 'ortools', 'gurobi_network'], default="ortools")
